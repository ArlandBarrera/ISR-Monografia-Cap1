...
\begin{itemize}
    ...
    \begin{itemize}
        \item Se trata de recopilar un DataSet, como puede ser un propio o de algun sitio especializado como Kaggle, donde se tengan imágenes de cartón  y plástico en diversas condiciones de iluminación y ángulos. Esto nos da la oportunidad de que el modelo sea robusto y pueda manejar variaciones en el entorno real.
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Implementaremos un sistema de retroalimentación visual (por ejemplo, luces LED) que indique al usuario si la clasificación fue correcta o incorrecta. Si el material es reconocido correctamente, se abrirá la compuerta; si no, se podrá mostrar con luces que indiquen que el material no fue clasificado.
        \end{itemize}
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item En caso de que el material no sea reconocido, se proporcionará retroalimentación al usuario sobre la incorrecta clasificación con el uso de un LED de color rojo.
\end{itemize}
