\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \hline
        Servomotores MG995 & 2 & 8.99 \\
        \hline
        Contenedor de basura & 1 & 8.99 \\
        \hline
        ...
        \hline
        \textbf{Total} & & \textbf{697.59} \\
        \hline
    \end{tabular}
    \caption{Presupuesto Real del Proyecto}{Precios de referencia:~\cite{link_arduino,link_esp32,link_servos,link_conectores_cables,link_protoboard,link_buzzer}}
...
\begin{itemize}
    ...
    El hecho de incluir un buzzer se trata de un mecanismo de retroalimentación para el usuario, posiblemente para indicar si un material ha sido clasificado correctamente o no.
