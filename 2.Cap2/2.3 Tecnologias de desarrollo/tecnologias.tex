...
\subsection{Seeed Studio XIAO ESP32S3 Sense}
...
\begin{figure}[htb]
	\centering
	\includegraphics[scale  = 0.40]{Imagenes/esp32s3_antena.png}
	\caption{Antena Wifi/Bluetooth}{Fuente: Adaptado de~\cite{esp32_wiki}}
\end{figure}
